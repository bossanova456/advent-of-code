...
const isOverlapping = (pairs) => {
    // Expecting an array of two arrays of values, with larger values at the end

    // Check low end of each pair
    return pairs[0][0] >= pairs[1][0] ?
        // Pair 1 range low end is larger or equal, check if upper end of Pair 2 is higher than lower end of Pair 1
        pairs[0][0] <= pairs[1][1] :
        // Pair 2 range low end is larger or equal, check if upper end of Pair 1 is higher than lower end of Pair 2
        pairs[1][0] <= pairs[0][1];
}
